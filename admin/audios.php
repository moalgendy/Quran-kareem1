...
<div class="container">
        <a href="audios_sel.php" class="btn btn-light mb-3"><< Go Back</a>
       
      
        <!-- Create Form -->
        <div class="card border-danger">
            <div class="card-header bg-danger text-white">
                <strong> اضف صوت جديد</strong>
            </div>
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-row"> <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-4">
                            <label for="image" class="col-form-label">الصوت</label>
...
if(isset($_POST['add'])){
   ...
   if(move_uploaded_file($_FILES['m']['tmp_name'] , $up)){
       $name = $_POST['name'];
       $video = $_FILES['m']['name'];
       $ins = mysqli_query($con  , "insert into `audios`(`name` ,`audios`) values ('$name' , '$video')");
   }
}
